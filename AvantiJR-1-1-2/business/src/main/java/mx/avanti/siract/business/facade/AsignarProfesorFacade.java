...
import mx.avanti.business.delegate.DelegateAsignarProfesor;
 ...
 * @author NOE_LOPEZ
 */
public class AsignarProfesorFacade {
    ...
    private DelegateAsignarProfesor delegate;

    public AsignarProfesorFacade() {
    ...
    public List<Profesor> getListaProfesor() {
        return delegate.getListaProfesor();
    }
    /**
    ...
    public void agregarProfesor(Profesor profesor) {
        delegate.agregarProfesor(profesor);
    }
    /**
     * Eliminar Profesor
     *
    ...
    public List<Areaconocimiento> getListaAreaConocimiento() {
        return delegate.getListaAreaConocimiento();
    }
    /**
    ...
    public void agregarAreaConocimiento(Areaconocimiento areaconocimiento) {
        delegate.agregarAreaConocimiento(areaconocimiento);
    }
    /**
    ...
    public void eliminarAreaConocimiento(Areaconocimiento areaconocimiento) {
        delegate.eliminarAreaConocimiento(areaconocimiento);
    }
    /**
...
//        return delegate.getPlanesByPrograma(idPrograma);
//    }
    /**
    ...
    public List<Profesor> getProfesor(int idPrograma) {
        return delegate.getProfesor(idPrograma);
    }
}