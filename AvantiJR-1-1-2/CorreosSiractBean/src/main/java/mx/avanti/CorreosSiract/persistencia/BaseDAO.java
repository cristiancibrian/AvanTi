...
//            result = (List<T>) HibernateUtil.getSession().createQuery("select a from "+getTipo().getCanonicalName()+" a where a."+campo+
//                    "="+criterio).list();
            String asd = "select distinct a from " + getTipo().getCanonicalName() + " a join a." + de + " b where b." + campo + "=" + criterio +"";
            ...
            result = (List<T>) HibernateUtil.getSession().createQuery(asd).list();
