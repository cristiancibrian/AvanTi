...
public class DelegateUnidadAprendizajeTieneContenidotematico {
    ...
    public List<UnidadaprendizajeTieneContenidotematico> unidadesTieneContenidoPorPE(int peid, int cesid){
        List<UnidadaprendizajeTieneContenidotematico> result =  new ArrayList<UnidadaprendizajeTieneContenidotematico>();
 
        try{
            
            result = ServiceLocator
                    .getInstanceUnidadAprendizajeTieneContenidotematicoDAO()
                    .unidadesTieneContenidoPorPE(
                     "CALL ContenidoTematicoPorProgramaEducativo("+ "\'" + peid + "\',"+ "\'" + cesid + "\')");
