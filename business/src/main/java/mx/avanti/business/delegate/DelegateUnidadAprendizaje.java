...
public void agregarUnidadAprendizaje(Unidadaprendizaje unidadAprendizaje) {
        ...
        int x=unidadAprendizaje.getUAPid();
        ServiceLocator.getInstanceUnidadAprendizajeTieneContenidotematicoDAO().executeProcedure("CALL siract.guardar_UnidadAprendizajePCT(1,"+unidadAprendizaje.getCicloEscolarCESid().getCESid()+","+x+",false,false,false,false)");
    }
    ...
    public List<Unidadaprendizaje> getlistaunidadaprendizajealumno(int id, int ce){
        return ServiceLocator.getInstanceUnidadAprendizajeDAO().getListaUnidadAprendizajedeAlumno(id, ce);
    }
}
