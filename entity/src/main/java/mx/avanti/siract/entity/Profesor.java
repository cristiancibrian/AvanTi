...
public class Profesor implements Serializable {
    ...
    @JoinTable(
            name = "profesor_pertenece_unidadacademica",
            joinColumns = {
...
//    @ManyToMany
//    @JoinTable(
//            name = "responsableprogramaeducativo",
//            joinColumns = {
//                    @JoinColumn(name = "Profesor_PROid", referencedColumnName = "PROid")
//            },
//            inverseJoinColumns = {
...
@XmlTransient
    ...
    public String toString() {
        return String.format("%s %s %s", this.pROapellidoPaterno, this.pROapellidoMaterno, this.pROnombre);
    }

    public List<ResponsableProgramaEducativo> getResponsableProgramaEducativosList() {
        return responsableProgramaEducativos;
    }

    public void setResponsableProgramaEducativosList(List<ResponsableProgramaEducativo> responsableProgramaEducativos) {
        this.responsableProgramaEducativos = responsableProgramaEducativos;
    }
//        public List<Programaeducativo> getProgramaeducativoList() {
//        return programaeducativoList;
//    }
