...
public class Programaeducativo implements Serializable {
    ...
    @OneToMany(mappedBy = "programaeducativo", cascade = CascadeType.ALL)
...
//    }
    ...
    public void setResponsableProgramaEducativoList(List<ResponsableProgramaEducativo> responsableProgramaEducativos) {
        this.responsableProgramaEducativos = responsableProgramaEducativos;
    }

    public List<ResponsableProgramaEducativo> getResponsableProgramaEducativoList() {
