...
public class Alumno implements Serializable {
    ...
    @OneToMany(mappedBy = "alumnoALId")
    private List<Politicaevaluacion> politicaevaluacionList;
    ...
    @XmlTransient
    public List<Politicaevaluacion> getPoliticaevaluacionList() {
        return politicaevaluacionList;
    }

    public void setPoliticaevaluacionList(List<Politicaevaluacion> politicaevaluacionList) {
        this.politicaevaluacionList = politicaevaluacionList;
    }
    ...
    public String toString() {
        return "mx.avanti.siract.entity.Alumno[ aLId=" + aLId + " ]";
    }
