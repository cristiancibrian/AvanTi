...
public class RACTBeanHelper {
    ...
    List<ProfesorPerteneceProgramaeducativo> programas;
    ...
    public List<Programaeducativo> programasEducativosProfesor(Profesor profesor, String cicloEscolar) {
        ...
        programaEducativos.clear();
        programas=ServiceFacadeLocator.getInstanceProfesorPertenecePEFacade().getProfesorPertenecePorProfesor(profesor.getPROid());
            if(programas == null || programas.size() == 0){
                return null;
            }else{
               
        for (ProfesorPerteneceProgramaeducativo pp : programas) {
