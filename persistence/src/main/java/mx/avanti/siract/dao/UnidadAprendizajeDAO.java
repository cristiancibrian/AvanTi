...
public class UnidadAprendizajeDAO extends AbstractDAO<Integer, Unidadaprendizaje> {
    ...
    public List<Unidadaprendizaje> unidadByUnidadAcademica(String idUA) {
        ...
        public List<Unidadaprendizaje> getListaUnidadAprendizajedeAlumno(int id,int ce) {
        return executeProcedure("CALL ConsultarPoliticasCompletasAlumno(:id,:ce)", new String[]{"id","ce"},String.valueOf(id),String.valueOf(ce));
    }
}
